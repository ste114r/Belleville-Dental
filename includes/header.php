<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white fixed-top">
    <div class="container">
        <a class="navbar-brand" href="index.php"><img src="images/Belleville Dental logo transparent.png" height="90"></a>
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarResponsive">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="product.php"><i class="fa-newspaper-o fa"></i> Product</a>
                </li>
                <li class="nav-item">

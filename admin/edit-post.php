...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query = mysqli_query($con, "UPDATE ARTICLES 
                                                    SET title = '$posttitle', 
                                                        category_id = '$catid', 
                                                        content = '$postdetails', 
                                                        slug = '$url', 
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" name="subcategory" id="subcategory" required>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-b-30 m-t-0 header-title"><b>Article Image</b></h4>
                                    <img src="postimages/<?php echo htmlentities($row['cover_image_url']); ?>" width="300" />
                                    <br />

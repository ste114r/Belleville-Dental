...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "UPDATE PRODUCT_CATEGORIES SET name='$category', description='$description' WHERE pcategory_id='$catid'");
        if ($query) {
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <?php
                            $catid = intval($_GET['cid']);
                            $query = mysqli_query($con, "SELECT pcategory_id, name, description FROM PRODUCT_CATEGORIES WHERE is_active=1 AND pcategory_id='$catid'");
